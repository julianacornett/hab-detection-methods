...
labs_method <- c("5m bottle sample", "1m bottle sample")

plot_qpcr_raincloud <- ggplot(count_long, aes(x = factor(Method), y = value)) + 
  ggdist::stat_halfeye(
    aes(color = Method,
  ...
  scale_x_discrete(labels=c("Count_5m_L" = "Microscope (5m)", "Count_1m_L" = "Microscope (1m)"))
plot_qpcr_raincloud
```
