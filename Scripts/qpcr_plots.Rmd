...
```{r}
ggplot(count_depths, aes(x = Quantity_Mean, y = Count_L, color = Depth, fill = Depth, shape = Depth)) + 
  scale_fill_manual(values = c("darkorange", "darkturquoise"), labels = c("1m", "5m")) +
  scale_color_manual(values = c("darkorange", "darkturquoise"), labels = c("1m", "5m")) +
