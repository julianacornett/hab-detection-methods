...
```{r}
tobit_pst = tobit(PST_ELISA_ug_100g~PST_MBA_ug_100g, data = pst, left = 34)
summary(tobit_pst)

#tobit regression with removal of influential point
pst_inf <- subset(pst, PST_ELISA_ug_100g < 200)
tobit_pst_inf = tobit(PST_ELISA_ug_100g~PST_MBA_ug_100g, data = pst_inf, left = 34)
summary(tobit_pst_inf)
```
